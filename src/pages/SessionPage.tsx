        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "20px 18px 40px" }}>
          ...
          {authState === "pending" ? (
            ...
            <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 18, padding: "18px 16px", textAlign: "center" }}>
              ...
              {!user ? (
                <>
                  <button onClick={() => navigate("/auth")} aria-label="Sign in to join this session" style={{ width: "100%", background: "#fff", border: "none", color: "#3c3c3c", padding: "16px 14px", borderRadius: 16, display: "flex", alignItems: "center", justifyContent: "center", gap: 12, fontSize: 15, fontWeight: 700, cursor: "pointer", boxShadow: "0 10px 24px rgba(0,0,0,0.18)" }}>
