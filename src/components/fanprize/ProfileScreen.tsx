...
export default function ProfileScreen() {
  ...
  return (
    <div className="px-5 pt-5 pb-24 overflow-y-auto h-full no-scrollbar">
      ...
      {/* Menu */}
      {["Edit Profile", "Referral Code", "Notifications", "Help Center", "Sign Out"].map(item => (
        <div key={item} className="flex items-center justify-between py-3.5 border-b border-border cursor-pointer">
