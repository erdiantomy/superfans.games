...
export default function HomeScreen({ onPick }: HomeProps) {
  ...
  return (
    <div className="px-5 pt-5 pb-24 overflow-y-auto h-full no-scrollbar" style={{ boxSizing: "border-box" }}>
      {/* Header */}
      ...
      {live.map(m => (
        ...
        >
          ...
          <div className="bg-accent rounded-lg p-3 text-center mb-3">
            ...
            <div className="font-display text-[28px] font-black text-green leading-tight">{idr(pool)}</div>
      ...
      <div className="mt-5">
        ...
        {LEADERBOARD.slice(0, 3).map(u => (
          <div key={u.rank} className="bg-card border border-subtle rounded-lg px-3.5 py-3 mb-1.5 flex items-center gap-3">
